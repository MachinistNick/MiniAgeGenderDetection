...
# video url to predict Age and gender
...
url = 'https://www.youtube.com/watch?v=WMGCeCCcEcc'
...
#Many times, we have to capture live stream with camera. OpenCV provides a very simple interface to this.
...
cap.set(3, 580) #set width of the frame
cap.set(4, 740) #set height of the frame

MODEL_MEAN_VALUES = (78.4263377603, 87.7689143744, 114.895847746)
age_list = ['(0, 3)', '(4, 6)', '(7, 12)', '(13, 20)','(21, 24)', '(25, 32)', '(38, 43)', '(48, 53)', '(60, 100)']
gender_list = ['MALE', 'FEMALE']
...
def read_from_camera(age_net, gender_net):
	...
	while True:
       ...
       #loading pre built model for facial recognition
